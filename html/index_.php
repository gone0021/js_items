...
<body>
    <div class="container">
        ...
        <form action="./" method="POST" class="form_3">
            ...
            <input type="submit" name="_post_meny" value="new_meny" id="">
        </form>
        
        <form action="./" method="POST" class="form_1">
            <div>
                <input type="text" name="name[title][]" id="" required>
                <select name="name[tag][]" id="">
                    <option value="0">趣味</option>
                    <option value="1">付き合い</option>
                    <option value="2">仕事</option>
                </select>
        ...
        <form action="./" method="POST" class="form_2">
            <div>
                <input type="text" name="name[1][title]" id="" required>
                <select name="name[1][tag]" id="">
                    <option value="0">趣味</option>
                    <option value="1">付き合い</option>
                    <option value="2">仕事</option>
                </select>
            ...
            <div>
                <input type="text" name="name[2][title]" id="" required>
                <select name="name[2][tag]" id="">
                    <option value="0">趣味</option>
                    <option value="1">付き合い</option>
                    <option value="2">仕事</option>
                </select>
